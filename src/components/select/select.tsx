...
const DEFAULT_SELECT_TAG = "select" as const;

/**
 * Reactive state exposed to render-prop children of the select component.
 */
...
export type SelectProps<
  TTag extends ValidComponent = typeof DEFAULT_SELECT_TAG,
> = Props<
  TTag,
  SelectRenderPropArg,
  never,
...
/**
 * Renders the accessible, unstyled select component for Solid.
 */
export function Select<
  TTag extends ValidComponent = typeof DEFAULT_SELECT_TAG,
>(props: SelectProps<TTag>): Element {
  const generatedId = `headlessui-select-${createUniqueId()}`;
  ...
  const slot: SelectRenderPropArg = {
    get active() {
